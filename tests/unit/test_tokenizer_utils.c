...
void test_count_vs_extract(void)
{
	...
	printf(YEL "\"echo hello\" count: %d, extract: %d %s\n" RESET,
	...
	printf(YEL "\"echo 'hello world'\" count: %d, extract: %d %s\n" RESET,
		counted, extracted, counted == extracted ? GRN "PASS" : RED "FAIL");
	...
	printf(YEL "\"cat < input.txt | grep hello >> output.txt\" count: %d, extract: %d %s\n" RESET,
		counted, extracted, counted == extracted ? GRN "PASS" : RED "FAIL");
